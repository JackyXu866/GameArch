...
// Given a field of view bottom, top, left, right, near, far, compute a orthographic matrix
void mat4f_make_orthographic(mat4f_t* m, float b, float t, float l, float r, float n, float f);
